...
\section{计算几何}
\subsection{二维凸包}
\inputminted[breaklines, linenos]{c++}{geometry/convex.cc}
\subsection{半平面交}
\inputminted[breaklines, linenos]{c++}{geometry/half_plane.cc}
\subsection{最小圆覆盖}
\inputminted[breaklines, linenos]{c++}{geometry/cover.cc}
\subsection{三维几何}
\subsubsection{三维凸包}
\inputminted[breaklines, linenos]{c++}{geometry/3dconvex.cc}
\subsection{旋转卡壳}
\inputminted[breaklines, linenos]{c++}{geometry/rc.cc}
\subsection{三角剖分}
\inputminted[breaklines, linenos]{c++}{geometry/triangle.cc}
\subsection{扫描线}
\inputminted[breaklines, linenos]{c++}{geometry/scanning.cc}
\subsection{自适应辛普森积分}
\inputminted[breaklines, linenos]{c++}{geometry/simpson.cc}
